...
if (!empty($search_nom)) {
    $sql = "SELECT * FROM client WHERE nom_complet LIKE ? ORDER BY nom_complet ASC";
    $stmt = $db->prepare($sql);
    ...
    $clients = $db->query("SELECT * FROM client ORDER BY nom_complet ASC");
}
?>
...
<head>
    ...
    <title>Gestion Clients | DOMUS</title>
    ...
    <main class="main-content">
        ...
        <div class="header">
            <div class="header-content">
                <h1>Gestion des Clients <span class="logo-text">DOM<span>US</span></span></h1>
                <p>Administration de la base client DOMUS</p>
            </div>
        </div>
        ...
        <div class="filters-container">
            <div class="filters-header">
                ...
                <span class="filter-count">
                    <?php echo $clients->num_rows; ?> client<?php echo $clients->num_rows > 1 ? 's' : ''; ?>
                </span>
            </div>
            ...
            <form method="GET" action="" class="filters-form">
                ...
                <div class="filter-actions">
                    ...
                    <a href="liste_clients.php" class="btn-filter btn-reset">
        ...
        <div class="dashboard-card">
            <div class="card-header">
                <div>
                    <h3 class="card-title">
                        <i class="fa-solid fa-users"></i>
                        <?php echo !empty($search_nom) ? 'Résultats de la recherche' : 'Tous les clients'; ?>
                    </h3>
                    <p class="card-subtitle">
                        <?php if(!empty($search_nom)): ?>
                            <?php echo $clients->num_rows; ?> résultat<?php echo $clients->num_rows > 1 ? 's' : ''; ?> trouvé<?php echo $clients->num_rows > 1 ? 's' : ''; ?>
                        <?php else: ?>
                            Liste complète des clients inscrits sur la plateforme
                        <?php endif; ?>
                    </p>
                </div>
            </div>
            ...
            <div class="table-container">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="user-info">
                                        <div class="user-avatar">
                                            <?php echo strtoupper(substr($c['nom_complet'] ?? 'C', 0, 1)); ?>
                                        </div>
                                        <div class="user-details">
                                            <div class="user-name"><?php echo htmlspecialchars($c['nom_complet']); ?></div>
                                            <div class="user-id">ID: #<?php echo $c['id_cli']; ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="user-phone">
                                        ...
                                        <?php echo !empty($c['telephone']) ? htmlspecialchars($c['telephone']) : '<span style="color: #cbd5e1;">Non renseigné</span>'; ?>
                                    </div>
                                </td>
                                <td>
                                    <div class="date-cell">
                                        ...
                                        <?php 
                                            if (isset($c['date_inscription']) && $c['date_inscription'] != '0000-00-00') {
                                                echo date('d/m/Y', strtotime($c['date_inscription']));
                                            } else {
                                                echo 'N/A';
                                            }
                                        ?>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="connexion_forcee.php?id=<?php echo $c['id_cli']; ?>&role=client" 
                                           class="btn-action btn-login" 
                                           title="Se connecter en tant que ce client">
                                            <i class="fa-solid fa-user-check"></i>
                                        </a>
                                        <a href="detail_client.php?id=<?php echo $c['id_cli']; ?>" 
                                           class="btn-action btn-view" 
                                           title="Voir détails">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>
                                        <a href="supprimer_client.php?id=<?php echo $c['id_cli']; ?>" 
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <?php if (!empty($search_nom)): ?>
                        <a href="liste_clients.php" class="btn-filter btn-reset" style="margin-top: 15px;">
                            <i class="fa-solid fa-rotate-left"></i>
